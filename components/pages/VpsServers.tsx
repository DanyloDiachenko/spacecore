...
import VpsServersPageComponentProps from "interfaces/vpsServersPageComponent.props";
...
const VpsServers = ({
    ...
    cores,
    disksVolume,
}: VpsServersPageComponentProps): JSX.Element => {
    ...
    useEffect(() => {
        makeQuery();
    }, [cpuCheckboxStates, diskCheckboxStates, countriesString]);
    ...
    return (
        <>
            ...
            <TariffesFilters
                ...
                // countriesCheckboxStates={countryCheckboxStates}
                // onCountriesCheckboxChange={handleCountryCheckboxChange}
            ...
            />
            <TariffesMain
                tariffes={tariffesBlock}
                tariffesContent={tariffes ? tariffes : []}
            />
...
export default connector(VpsServers);

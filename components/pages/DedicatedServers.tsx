...
import DedicatedServersPageComponentProps from "interfaces/dedicatedServersPageComponent.props";
...
const DedicatedServers = ({
    ...
    cores,
    disksVolume,
}: DedicatedServersPageComponentProps): JSX.Element => {
...
export default connector(DedicatedServers);
